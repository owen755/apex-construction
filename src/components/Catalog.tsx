...
const products = [
  ...
  { id: 5, title: "Good Wall Design", description: "Designer lighting and fixture styling tailored for living room feature walls and entertainment spaces. Custom pricing available — request a quote today.", img: livingRoomLightingPhoto, category: "Fixtures", price: "Custom quote after consultation" },
 ...
 { id: 7, title: "Living Room Wall Package", description: "Premium ceiling lighting that makes a bold statement in luxury interiors.", img: chandelierShowcase, category: "Fixtures", price: "Custom quote after consultation"  },
